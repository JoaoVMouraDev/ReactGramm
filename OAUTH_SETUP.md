...
6. Em **Authorized redirect URIs**, adicione:
   ...
   - `https://react-gramm.vercel.app/api/auth/google/callback` (prod)
...
2. Preencha:
   ...
   - **Homepage URL**: `https://react-gramm.vercel.app`
   - **Authorization callback URL**: `https://react-gramm.vercel.app/api/auth/github/callback`
